...
export default function PollVisibilitySelector({ visibility, onChange }) {
  ...
  const alertMessage = (visibility === 'public') ? (
    <>
      You have
      chossen <strong>"public"</strong>,
      which means that this poll <strong>will</strong> appear
      when users search for polls
      and on "Random Public Polls".

      If you don't want this, choose <strong>"unlisted"</strong>.
    </>
  ) : (
    <>
      You have
      ...
      If you don't want this, choose <strong>"public"</strong>.
    </>
  );
